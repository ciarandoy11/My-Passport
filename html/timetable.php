...
<ul class='sideNav' id="mySidenav">
    <li><img onclick='document.location="dashboard"' src='/images/logo-rectangle.png' style='width: 39%'></li>
    <li><a href="dashboard">Home</a></li>
    <li><a class="active" href="timetable">Timetable</a></li>
    <li><a href="membership">Finances</a></li>
    <li><a href="comingSoon">Fundraising</a></li>
    <li><a href="emails">Emails Dashboard</a></li>
</ul>
