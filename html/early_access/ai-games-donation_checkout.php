...
try {
    ...
    $checkout_session = \Stripe\Checkout\Session::create([
        ...
        'mode' => 'payment',
        'success_url' => $YOUR_DOMAIN . '/alpha_env/ai-games-process_participation?gameId=' . $gameID . '&name=' . urlencode($name) . '&amount=' . $realAmount,
        'cancel_url' => $YOUR_DOMAIN . '/ai-games-participate?gameId=' . $gameID,
        'customer_email' => $email,
