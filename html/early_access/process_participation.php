...
function generate_cards($conn, $cards, $gameName, $club, $userId, $fundraisingId, $name) {
    ...
    for ($i = 0; $i < $cards; $i++) {
        ...
        if ($gameName === 'Bingo') {
			...
			$location = 'bingo?gameId=' . $fundraisingId;
            ...
            $location = 'lotto?gameId=' . $fundraisingId;
