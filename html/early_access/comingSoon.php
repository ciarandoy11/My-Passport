...
<body>
    ...
    <script>
        // Use PHP variable safely for JS
        const subscriptionTier = '<?php echo $subDirectory; ?>';
        // Set the date we're counting down to
        let countDownDate;
        if (subscriptionTier === 'early_access') {
            countDownDate = new Date("Jun 30, 2025 10:00:00").getTime();
        } else {
            countDownDate = new Date("July 30, 2025 10:00:00").getTime();
        }
        ...
        let countdownInterval = setInterval(function() {
            ...
            if (distance < 0) {
                ...
                <?php if ($typeAdmin !== 1): ?>
                    document.location.href = 'competitions';
                <?php elseif ($typeCoach === 1): ?>
                    document.location.href = 'coachCompetitions';
                <?php else: ?>
                    document.location.href = 'adminCompetitions';
                <?php endif; ?>
            }
        }, 1000);
        ...
        document.getElementById("access").addEventListener("click", function() {
            ...
            const correctPassword = 'Cn18012009!'; // The correct password (move to backend for real security)
        ...
        // Loading screen and scroll reveal
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Scroll reveal effect (no <section> elements, so this is not needed)
        });
    </script>
</body>
</html>
