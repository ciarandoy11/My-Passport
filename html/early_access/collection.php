        ...
        <ul>
            ...
            ?>
                <li class="fundraising-game">
                    ...
                    <a href="<?php echo $location; ?>?gameId=<?php echo $game['game_id']; ?>">Play</a>
                    <br>
                    <button onclick="window.location.href = 'leaderboard?gameId=<?php echo $game['game_id']; ?>';" style="background-color: #00FF00;">
                        Leaderboard
                    </button>
                </li>
            <?php endwhile; ?>
        ...
        <ul>
            ...
            ?>
                <li class="fundraising-game">
                    ...
                    <a href="<?php echo $location; ?>?gameId=<?php echo $game['gameId']; ?>">Play</a>
                    <br>
                    <button onclick="window.location.href = 'leaderboard?gameId=<?php echo $game['gameId']; ?>';" style="background-color: #00FF00;">
                        Leaderboard
                    </button>
                </li>
            <?php endwhile; ?>
