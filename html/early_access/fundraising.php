...
<main>
    ...
    <button onclick="window.location.href = 'collection';">Your Game Collection</button><br>
    ...
    <?php foreach ($games as $game): 
                ...
                <li class="fundraising-game">
                    ...
                    <a href="ai-games-participate?fundraising_id=<?php echo $game['id']; ?>">Participate</a>
                    <br>
    ...
    <?php if ($result->num_rows > 0): ?>
			...
			?>
                <li class="fundraising-game">
                    ...
                    Last Updated: <?php echo htmlspecialchars($formattedDate); ?> <br>
                    <a href="participate?fundraising_id=<?php echo $row['id']; ?>">Participate</a>
                </li>
            <?php endwhile; ?>
        <?php endif; ?>
</ul>
