  ...
  <main>
    ...
    <form method="POST" action="">
      ...
      <div style="position: relative;">
        <input type="text" style="width:100%" onkeyup="showResult(this.value)" id="club" name="club" placeholder="Club" required>
    ...
    <button onclick="document.location='club-signup'">Club Sign up</button>
  </main>
</body>
</html>
