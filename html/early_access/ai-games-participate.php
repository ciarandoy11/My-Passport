...
<body>
    <main>
        ...
        ?>
            <form method="POST" action="ai-games-donation_checkout?gameId=<?php echo $fundraisingId; ?>">
        ...
        ?>
                ...
                <button style="background-color: #00FF00;" onclick="window.location.href = '<?php echo $location; ?>?gameId=<?php echo $game['game_id']; ?>';">Play</button>
                <br>
                <button onclick="window.location.href = 'leaderboard?gameId=<?php echo $game['game_id']; ?>';">
                    Leaderboard
                </button>
        <?php
            endwhile;
