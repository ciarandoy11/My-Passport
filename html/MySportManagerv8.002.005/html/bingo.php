...
<body onload="fetchSelectedNumbers()">
    ...
    <div>
    <div class="actions">
            <a href="fundraising.php" class="btn">Back to Dashboard</a>
        </div>
        <h2>Your Bingo Cards</h2>
        <button onclick="document.location='participate.php?fundraising_id=<?php echo htmlspecialchars($gameID); ?>'">Generate a new card</button>
