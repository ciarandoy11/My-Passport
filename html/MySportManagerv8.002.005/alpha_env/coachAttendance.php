...
<?php echo("<h2>Hello " . $userName . "</h2>"); ?>
    ...
    <button style="background-color: blue; color: white;" onclick="document.location='coachs-site.php'">Back</button>
    ...
    <script>
        function loadSessionAttendance() {
            ...
            if (sessionID != '') {
                document.location = 'coachAttendance.php?id=' + sessionID + '&weekOffset=' + weekOffset;
            }
        }
