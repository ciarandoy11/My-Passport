...
// Assuming you have defined $email and $phone variables previously
...
<main>
    <h2>Personal Invoices:</h2>
    <?php
        // Fetch Customer data (Assuming you have a way to retrieve customer details)
try {
    ...
    $invoices = \Stripe\Invoice::all(['customer' => $customerId]); // Correct usage of parameters

    // Display invoices in a table
    //echo '<h2>Invoices for Customer ID: ' . htmlspecialchars($customerId) . '</h2>';
