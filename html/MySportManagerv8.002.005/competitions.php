                        ...
                        <?php while ($meet = $meets->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td style="text-align: center; vertical-align: middle;">
                                    <button onclick="location.href='viewMeet.php?id=<?php echo $meet['id']; ?>'" class="button">View Details</button>
                                    <button onclick="showEntryForm(<?php echo $meet['id']; ?>)" class="button">Enter Events</button>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
