...
<nav class="nav-container">
    <div class="nav-content">
        ...
        <div class="nav-links" id="navLinks">
            ...
            <a <?php echo $current_page == 'fundraising.php' ? 'class="active"' : ''; ?> href="fundraising.php">Fundraising</a>
            <a <?php echo $current_page == 'comingSoon.php' ? 'class="active"' : ''; ?> href="comingSoon.php" style="color: orange;">Competitions (Coming Soon)</a>
