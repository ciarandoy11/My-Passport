...
require_once 'vendor/autoload/ Ensure the `vendor` directory is in the correct path
...
if ($stripeSecretKey) {
    ...
    try {
        ...
        $checkout_session = \Stripe\Checkout\Session::create([
            ...
            'success_url' => $YOUR_DOMAIN . '/alpha_env/process_participationeId=' . $gameID . '&name=' . urlencode($name) . '&amount=' . $realAmount . '&cards=' . $cards,
            'cancel_url' => $YOUR_DOMAIN . '/participate/ Change to your failure page
