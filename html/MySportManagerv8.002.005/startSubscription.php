...
try {
    ...
    $checkout_session = \Stripe\Checkout\Session::create([
        ...
        'mode' => 'subscription',
        'success_url' => $YOUR_DOMAIN . '/continueClubSignup.php?club=' . $clubName . '&username=' . $inputUsername . '&password=' . $inputPassword . '&first_name=' . $firstName . '&last_name=' . $lastName . '&email=' . $email . '&phone=' . $phone,
