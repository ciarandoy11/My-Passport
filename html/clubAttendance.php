...
<?php echo("<h2>Hello " . $userName . "</h2>"); ?>
    <div class='week-navigation'>
        ...
        <button style="background-color: blue; color: white;" onclick="document.location='admin.php'">Back</button>
    ...
    <script>
        function loadSessionAttendance() {
            ...
            if (sessionID != '') {
                document.location = 'clubAttendance.php?id=' + sessionID + '&weekOffset=' + weekOffset;
            }
        }
